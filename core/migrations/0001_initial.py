# Generated by Django 4.0.3 on 2022-04-25 21:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-rocket', 'foguete'), ('lni-stats-up', 'grafico'), ('lni-cog', 'engrenagem'), ('lni-mobile', 'mobile'), ('lni-layers', 'design'), ('lni-users', 'clientes')], max_length=15, verbose_name='Icone')),
            ],
            options={
